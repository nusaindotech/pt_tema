...
<p align="center"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data Canvaser</h2></p>
              <div class="row">
                  <div class="col-lg-12">
  ...
  <div class="panel-body">
                                <div class="adv-table">
                                    <table  class="display table table-bordered" id="example">
                                      ...
                                      <tr>
                                          <th width="10%">No.</th>
                                          <th width="100px">Nama Canvaser</th>
                                      </tr>
                                      </thead>
                                      <tbody>
										 <?php 
											...
											$tampil=mysql_query("select * from tb_sales order by nama_sales ASC");
											$no=1;
										...
										?>
											<tr bgcolor="fefefe" title="Pilih Canvaser" style="cursor:pointer" onMouseOver="this.className='rowover';" onMouseOut="this.className='rowselected-even';"
												...
												javascript:window.opener.document.getElementById('id_sales').value='<?php echo $row['id_sales'];?>';
												javascript:window.opener.document.getElementById('nama_sales').value='<?php echo $row['nama_sales'];?>'">
												
												<td height="26" align="center" class="text"><font size="2.3 em"><?php echo $row['id_sales'];?></font></td>
												<td align="left" class="text"><font size="2.3 em"><?php echo $row['nama_sales'];?></font></td>
