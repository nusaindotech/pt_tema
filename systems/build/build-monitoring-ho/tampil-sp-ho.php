					...
					<div class="page-content">
						...
						<div class="col-xs-12">
										...
										<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
												...
												$tampil=mysql_query("select distinct(hu_2) from tb_sp 
												where id_ho='$id_ho' and id_kios='0' and id_sales='0'");
												$no=1;
												...
												<tr>
													...
													<td align="center"><a href="dash.php?hp=monitoring-ho2&hu2=<?php echo $row[0]; ?>"><?php echo $row[0]; ?></a></td>
                                                    <?php
                                                    $bantu="select count(hu_2)
															from tb_sp
															where hu_2='$row[0]' and id_ho='$id_ho' and id_kios='0' and id_sales='0'";
