<!-- #section:basics/content.breadcrumbs -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Verifikasi Penjualan Dompul</h1>
						</div><!-- /.page-header -->

						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="dash.php?hp=verifikasi-penjualan-dompul2" method="POST" class="form-horizontal" role="form">
								  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    
									<tr>
                                      <td width="13%">Pilih Tanggal</td>
                                      <td width="1%">:</td>
