									...
									<div class="col-xs-12">
									  <table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tr>
												...
												<td>&nbsp;</td>
												<td>&nbsp;</td>
												<td colspan="2"><strong>Bank Transfer</strong></td>
												<td>&nbsp;</td>
												<td><strong>
                                                  <input type="button" class="btn btn-info view_data" name="tanggal_input" value="Pilih Bank" id="<?php echo $row["tanggal_input"]?>" data-toggle="modal" data-target="#dataModal"><?php echo $row["tanggal_input"]?></strong>
                                                </strong></td>
									          	<td>&nbsp;</td>
											</tr>
											<tr>
			...
			<script>
				$(document).ready(function () {
					$('.view_data').click(function () {
						var id_rekening = $(this).text();

						$.ajax({
							url:"build/build-rekening-koran/daftar-rekening-koran.php",
							type: "POST",
							data:{id_rekening:id_rekening},
							success:function (data) {
								$('#daftar-rekening-koran').html(data);
