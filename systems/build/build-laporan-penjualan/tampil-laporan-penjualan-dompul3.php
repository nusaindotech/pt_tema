							...
							<div class="col-xs-12">
								...
								<div class="row">
								  ...
								  <table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											WHERE hp_sales = '$canvaser' and status_bayar_dompul='1' and tanggal_transaksi = '$tanggal_awal' 
											GROUP BY nama_kios
											...
											<tr>
											  ...
											  <td class="info" align="center"><a href="dash.php?hp=laporan-pj-dompul4&tanggal_awal=<?php echo $tanggal_awal; ?>&hp_kios=<?php echo $row3['hp_kios']; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>&hp_sales=<?php echo $canvaser; ?>" ><?php echo $row3['nama_kios'];?></a></td>
