	<?php 
		...
		$query  = mysql_query("select * from tb_sales where id_sales='$id'") or die(mysql_error());
			...
			$.ajax({
				...
				success: function(msg){
					...
					<div class="modal-body">
						<form role="form" action="build/build-master-canvaser/update-canvaser.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
						<input type="hidden" value="<?php echo $id;?>" name="id_sales">
                           <div class="control-group">
                                <label class="control-label">Nama Canvaser</label>
                                <div class="controls">
                                    <input type="text" class="form-control" id="exampleInputPassword3" name="nama_sales" placeholder="Isikan Sales" required="require" 
							...
							<div class="control-group">
                                ...
                                <div class="controls">
									...
									value="<?php echo $data['alamat_sales'];?>">
								</div>
                            </div>
							<div class="control-group">
                                <label class="control-label">Telepon</label>
                                <div class="controls">
                                    <input type="text" class="form-control" id="exampleInputPassword3" name="telepon_sales" placeholder="Isikan Telepon"  
									value="<?php echo $data['telepon_sales'];?>">
								</div>
                            </div>
							<div class="control-group">
                                <label class="control-label">HP</label>
                                <div class="controls">
                                    <input type="text" class="form-control" id="exampleInputPassword3" name="hp_sales" placeholder="Isikan HP" required="require" 
									value="<?php echo $data['hp_sales'];?>">
								</div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
									...
									value="<?php echo $data['email_sales'];?>">
								</div>
                            </div>
							<div class="control-group">
